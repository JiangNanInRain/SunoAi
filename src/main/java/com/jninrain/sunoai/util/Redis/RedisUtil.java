...
public class RedisUtil {
    ...
    public void del(String... key) {
        if (key != null && key.length > 0) {
            if (key.length == 1) {
                ...
                redisTemplate.delete((Collection<String>) CollectionUtils.arrayToList(key));//CollectionUtils.arrayToList(key)
            }
        }
    }
    // ============================String=============================
    ...
    public boolean zincrby(String key,int num,String value){
     ...
     * @return boolean
     */
    public boolean dbSet(final String key, Object value,int db,Long timeOut) {
        boolean result = false;
        try {
     ...
     * @return Object
     */
    public Object dbGet(final String key,int db) {
        Object result = null;
        try {
            RedisConnection redisConnection = redisTemplate.getConnectionFactory().getConnection();
            DefaultStringRedisConnection stringRedisConnection = new DefaultStringRedisConnection(redisConnection);
     ...
     * @param db
     */
    public void dbRemove(final String key ,int db) {
        try {
            RedisConnection redisConnection = redisTemplate.getConnectionFactory().getConnection();
            DefaultStringRedisConnection stringRedisConnection = new DefaultStringRedisConnection(redisConnection);
            stringRedisConnection.select(db);
